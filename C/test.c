...
int main() {
  ...
  case 5:
    infoChoosen(switch_1);
    printf("Bubble sort\n");
    int unsorted_array[10] = {3,5,1,14,7,74,8,27,15,10};
    len = sizeof(unsorted_array)/sizeof(unsorted_array[0]);
    printf("Nesetrideny retezec je: \n");
    printf("delka je %d\n", len);
    for (int i=0;i<9;i++){
